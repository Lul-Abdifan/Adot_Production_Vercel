...
import { useArchiveUserMutation } from "../../api/user-api";
...
export const DeleteUserDialog: FC<DialogProps> = ({ _id, setOpen }) => {
    ...
    const deleteUser = async () => {
        setLoading(true);
        const res: any = await archiveUser({ id: _id });
                            ...
                            <div className="rounded-2xl shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                ...
                                <div className="relative px-24 py- mx-auto">
                                    ...
                                    <p className="text-xs text-archive pt-2 opacity-30 text-center">
                                        Archiving this user will not delete this
                                        users&apos; account, it will simply
                                        restrict the user from accessing this
                                        platform.
                                    </p>
                                </div>
