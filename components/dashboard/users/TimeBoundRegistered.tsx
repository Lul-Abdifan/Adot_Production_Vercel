...
import { formatDateShortYear, getNextSaturday, getPreviousSunday } from "@/utils/date-format";
...
const NewRegisteredUsers: FC<ChartProps> = ({ chartHeight }) => {
  ...
  const { data, isSuccess } = useGetDailyRegisteredDoctorsQuery({
    startDate,
    endDate,
  });
        ...
        <div className="flex">
          <div className="w-full">
            ...
            <div className="flex flex-col items-start">
              <p className="mt-2 text-sm text-gray-600">Time-Bound Registered Doctors</p>
              <PercentageIndicator
